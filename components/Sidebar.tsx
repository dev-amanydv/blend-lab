...
export default function Sidebar() {
  ...
  return (
    <div className='flex flex-col justify-between fixed top-0 w-1/5 left-0 dark:bg-primary-dark backdrop-blur-3xl h-screen ' >
      ...
      <div className='flex p-3 dark:bg-[#1E1E1E] bg-gray-300 cursor-pointer w-full'>
