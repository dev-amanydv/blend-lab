      ...
      <div className='flex flex-col gap-5'>
        ...
        <div className='flex flex-col gap-5 mx-2'>
            <div className='flex flex-col'>
              ...
              <Link href={'/remove-bg'}>
                <div className={`flex gap-2 items-center ${pathname === '/remove-bg' ? 'dark:bg-[#262626] bg-[#d5d5d5] dark:hover:bg-[#262626]' : "dark:hover:bg-[#262626]/50"} rounded-md py-2 px-3  hover:backdrop-blur-2xl cursor-pointer hover:bg-neutral-300/40 font-light text-sm`}> {theme === 'light' ? (<Image src={'/bg-remove-light.png'} height={18} quality={100} width={18} alt='background-remove' />) : (<Image src={'/bg-remove-dark.png'} quality={100} height={18} width={18} alt='background-remove' />)} Remove Background <div className='text-[10px] bg-blue-400 font-medium mb-2 text-black rounded-md px-1'>New</div></div>
              </Link>
              <Link href={'#'}>
